...
export function parseQuery(raw) {
  ...
  const sourceMatch = input.match(/(?:^|\s)source:(wikipedia|crossref|openalex|openlibrary|googlebooks|google|loc|gutenberg|internetarchive|wikimedia|wikidata|europepmc|gdelt|searxng|stackoverflow|superuser|mdn|github|gitlab|pinterest)(?=\s|$)/i);
  ...
  const query = input
    ...
    .replace(/(?:^|\s)source:(?:wikipedia|crossref|openalex|openlibrary|googlebooks|google|loc|gutenberg|internetarchive|wikimedia|wikidata|europepmc|gdelt|searxng|stackoverflow|superuser|mdn|github|gitlab|pinterest)(?=\s|$)/gi, " ")
